    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Diretores",
                columns: new[] { "Id", "Bio", "DataNasc", "Nome" },
            ...
            migrationBuilder.InsertData(
                table: "Filmes",
                columns: new[] { "Id", "Ano", "DataLancamento", "Descricao", "DiretorId", "Duracao", "GeneroId", "IdiomaOriginal", "Poster", "Titulo" },
                values: new object[] { 1, 1999, "29/10/1999", "Um trabalhador de escritório e um fabricante de sabonetes que cuidam do diabo formam um clube de luta clandestino que evolui para algo muito maior.", 1, 139, 1, "EN", "", "Clube da Luta" });

            migrationBuilder.InsertData(
                table: "Filmes",
                columns: new[] { "Id", "Ano", "DataLancamento", "Descricao", "DiretorId", "Duracao", "GeneroId", "IdiomaOriginal", "Poster", "Titulo" },
                values: new object[] { 2, 2019, "06/02/2019", "Um jovem parte do exército nazi, descobre que sua mãe esconde uma jovem judia na sua casa.", 2, 108, 2, "EN", "", "Jojo Rabbit" });
